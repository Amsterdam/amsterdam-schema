create or replace view public.dataverkenner_bagadresinformatie_bagadresinformatie_v0 WITH (security_barrier) as
select
...
left join bag_verblijfsobjecten_toegang_v1 on bag_nummeraanduidingen_v1.adresseert_verblijfsobject_id=bag_verblijfsobjecten_toegang_v1.parent_id;
