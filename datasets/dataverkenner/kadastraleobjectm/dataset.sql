CREATE MATERIALIZED VIEW IF NOT EXISTS public.dataverkenner_kadastraleobjectm_kadastraleobject_v0 as
...
LEFT JOIN brk_2_gemeentes ON brk_2_kadastraleobjecten_v2.aangeduid_door_brk_gemeente_id=brk_2_gemeentes_v1.id
